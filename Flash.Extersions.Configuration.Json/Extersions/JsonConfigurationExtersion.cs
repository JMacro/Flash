...
namespace Microsoft.Extensions.DependencyInjection
{
    public static class JsonConfigurationExtersion
    {
        ...
        public static IConfigurationBuilder AddJsonFile(this IConfigurationBuilder builder, Action<Flash.Extersions.Configuration.Json.JsonConfigurationSource> configureSource)
        {
            return ConfigurationExtensions.Add<Flash.Extersions.Configuration.Json.JsonConfigurationSource>(builder, configureSource);
        }
    }
}
