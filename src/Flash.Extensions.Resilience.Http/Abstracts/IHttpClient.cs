...
namespace Flash.Extensions.Resilience.Http
{
    public interface IHttpClient
    {
        ...
        Task<HttpResponseMessage> PostAsync<T>(string uri, T item, HttpMediaType httpMediaType, string authorizationToken = null, string authorizationMethod = "Bearer", IDictionary<string, string> dictionary = null, CancellationToken cancellationToken = default(CancellationToken));
        ...
        Task<HttpResponseMessage> PutAsync<T>(string uri, T item, HttpMediaType httpMediaType, string authorizationToken = null, string authorizationMethod = "Bearer", IDictionary<string, string> dictionary = null, CancellationToken cancellationToken = default(CancellationToken));
    }
}
