...
namespace Flash.Extensions.Tracting.Skywalking.Sampling
{
    public class SimpleCountSamplingInterceptor : ExecutionService, ISamplingInterceptor
    {
        ...
        public SimpleCountSamplingInterceptor(SkyApmConfig configAccessor, IRuntimeEnvironment runtimeEnvironment, ILoggerFactory loggerFactory) :
            base(runtimeEnvironment, loggerFactory)
        {
            var samplingConfig = configAccessor?.Sampling;
